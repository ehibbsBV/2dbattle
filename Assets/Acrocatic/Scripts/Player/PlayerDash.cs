...
public class PlayerDash : MonoBehaviour
{
	...
	// true if dash is allowed by player state
	bool CanDash ()
	{
		return dashAllowed && !player.dashing && !player.crouching && !player.stuckToWall && !player.falling && !player.sliding && !player.onLadder;
	}
